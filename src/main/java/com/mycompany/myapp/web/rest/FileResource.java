        ...
        Optional<File> result = fileRepository
            ...
            .map(existingFile -> {
                if (file.getUuid() != null) {
                    existingFile.setUuid(file.getUuid());
                }
                if (file.getDirectoryUuid() != null) {
                    existingFile.setDirectoryUuid(file.getDirectoryUuid());
                }
                if (file.getName() != null) {
                    existingFile.setName(file.getName());
                }
                if (file.getRemotePath() != null) {
                    existingFile.setRemotePath(file.getRemotePath());
                }
                if (file.getTenantId() != null) {
                    existingFile.setTenantId(file.getTenantId());
                }
                if (file.getContentType() != null) {
                    existingFile.setContentType(file.getContentType());
                }
                if (file.getSizz() != null) {
                    existingFile.setSizz(file.getSizz());
                }
                if (file.getCreateDate() != null) {
                    existingFile.setCreateDate(file.getCreateDate());
                }
                if (file.getUserName() != null) {
                    existingFile.setUserName(file.getUserName());
                }
                ...
                if (file.getVirtualPath() != null) {
                    existingFile.setVirtualPath(file.getVirtualPath());
                }
                if (file.getIsDir() != null) {
                    existingFile.setIsDir(file.getIsDir());
                }
